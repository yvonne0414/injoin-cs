  ...
  return (
    <>
      ...
      <div className="page-type1-list-area position-relative about-us-session1">
        <div className="box-1" data-aos="fade-left" data-aos-easing="ease-in" data-aos-duration="1000"></div>
        <div className="container">
          <div className="page-type1-area-title" id="aboutus-bolck1" data-aos="fade-right" data-aos-easing="ease-in" data-aos-duration="1000">
            關於INJION
          </div>
          <div className="user-add-aboutus-content-text " data-aos="fade-right" data-aos-easing="ease-in" data-aos-duration="1000">
        ...
        <div className="about-us-img-1 " data-aos="fade-left" data-aos-easing="ease-in" data-aos-duration="1200">
          <img src={aboutusImg1} alt="about-us-img-1" />
        </div>
      </div>
      <div className="sesion2 position-relative">
        <div className="box-2" data-aos="fade-right" data-aos-easing="ease-in" data-aos-duration="1300"></div>
        <div className="container about-us-session2-content-wraper">
          <div className="about-us-session2-content-block1">
            <div className="page-type1-area-title" id="aboutus-bolck2" data-aos="fade-left" data-aos-easing="ease-in" data-aos-duration="1000">
              INJOIN的特色
            </div>
            <div className="user-add-aboutus-content-text" data-aos="fade-left" data-aos-easing="ease-in" data-aos-duration="1000">
          ...
          <div className="about-us-img-2 about-us-session2-content-block2" data-aos="fade-right" data-aos-easing="ease-in" data-aos-duration="1000">
            <img src={aboutusImg2} alt="about-us-img-2" />
          </div>
          <div className="user-add-aboutus-content-text about-us-session2-content-block3" data-aos="fade-right" data-aos-easing="ease-in" data-aos-duration="1000">
          ...
          <div className="about-us-img-3 about-us-session2-content-block4" data-aos="fade-left" data-aos-easing="ease-in" data-aos-duration="1000">
