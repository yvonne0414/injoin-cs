    ...
    <>
      ...
      <div className="bg-box prd-detail-session1">
        ...
        <div className="prd-detail-session1-content-wraper">
          ...
          <div className=" mt-3 prd-detail-session1-content-block1">
            <div>
              <div style={contentStyle}>
                <img src={bardetailImg1} alt="bartending-detail-img-1" className="mx-auto h-100" />
              </div>
            </div>
          </div>
          {/* instructions-------------------------------- */}
            ...
            <Collapse defaultActiveKey={['1']} onChange={onChange}>
              <Panel className="prd-detail-title-type1" header="產地規格" key="1">
                <p className="prd-detail-text-1">
                  ...
                  <br />
                  品牌：{specification.brand}
                </p>
              </Panel>
              <Panel className="prd-detail-title-type1" header="產品介紹" key="2">
                <p className="prd-detail-text">{text2}</p>
              </Panel>
          ...
          <div className="prd-detail-evaluation-bg mt-5">
            <div className="container">
              ...
              <div className="prd-detail-box-1">
                <div>
                  <p className="prd-detail-box-text1 mt-3">4.5</p>
                </div>
                ...
                renderItem={(item) => (
                  <li className="comment-list-li">
                    ...
                    <div className="d-flex comment-list-imgs">
                      <div className="flex-grow-1 mx-1 comment-list-img">{/* <img src={prddetailImg1} className="img-fluid object-cover" alt="" /> */}</div>
                      <div className="flex-grow-1 mx-1 comment-list-img">{/* <img src={prddetailImg1} className="img-fluid object-cover" alt="" /> */}</div>
                    </div>
                    <hr />
                  </li>
